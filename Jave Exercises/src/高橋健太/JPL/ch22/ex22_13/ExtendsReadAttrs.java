...
public class ExtendsReadAttrs {
	...
	public static Attributed readAttrs(Reader source) throws IOException{
		...
		Pattern illegal_1 = Pattern.compile("^(.*)=$", Pattern.MULTILINE);
		Pattern illegal_2 = Pattern.compile("^=(.*)", Pattern.MULTILINE);

		while(in.hasNextLine()) {
			if(in.findInLine(illegal_1) != null || in.findInLine(illegal_2) != null)
