...
public class Game {
	...
	static List<String> nameList = Arrays.asList("高橋健太.JPL.ch16.ex16_12.client.SimplePlayer", "高橋健太.JPL.ch16.ex16_12.client.RandomPlayer", "高橋健太.JPL.ch16.ex16_12.client.BoldPlayer");
	static int index = 0;
