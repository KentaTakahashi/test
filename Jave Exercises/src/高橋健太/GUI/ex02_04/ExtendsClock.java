...
public class ExtendsClock extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		select_color.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				myFontColor = colorchooser.showDialog(ExtendsClock.this, "カラーの選択", Color.white);
			}
		});
		...
		select_back_color.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JColorChooser colorchooser = new JColorChooser();
				myBackColor = colorchooser.showDialog(ExtendsClock.this, "背景色の選択", Color.white);
			}
		});
		...
		ok_btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//プリファレンス保存用
				myFontColorRed 		= myFontColor.getRed();
				myFontColorGreen 	= myFontColor.getGreen();
				myFontColorBlue 	= myFontColor.getBlue();
				System.out.println("Font R:" + myFontColorRed
						+ " G:" + myFontColorGreen
						+ " B:" + myFontColorBlue);

				time_panel.setForeground(myFontColor);


				//プリファレンス保存用
				myBackColorRed 		= myBackColor.getRed();
				myBackColorGreen 	= myBackColor.getGreen();
				myBackColorBlue 	= myBackColor.getBlue();
				System.out.println("BackColor R:" + myBackColorRed
						+ " G:" + myBackColorGreen
						+ " B:" + myBackColorBlue);

				time_panel.setBackground(myBackColor);
				...
				tmpFontColor	= myFontColor;
				tmpBackColor	= myBackColor;
			}
		});
    ...
    public void load() {
        ...
        myFontColor = new Color(myFontColorRed, myFontColorGreen, myFontColorBlue);
        myBackColor = new Color(myBackColorRed, myBackColorGreen, myBackColorBlue);
