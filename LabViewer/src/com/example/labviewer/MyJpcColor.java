...
public class MyJpcColor {
	...
	public MyJpcColor(){
		...
		float vertices[] = {
				...
				0.69f,	0.46f * 2.0f - 1.0f,	0.42f,	// R
				-0.06f,	0.88f * 2.0f - 1.0f,	0.92f,	// Y
				-0.71f,	0.50f * 2.0f - 1.0f,	0.25f,	// G
				-0.39f,	0.55f * 2.0f - 1.0f,	-0.49f,	// C
				0.18f,	0.23f * 2.0f - 1.0f,	-0.47f,	// B
				0.75f,	0.46f * 2.0f - 1.0f,	-0.06f,	// M
				0.69f,	0.46f * 2.0f - 1.0f,	0.42f,	// R

				// シャドー側の6角推
				0.01f,	0.14f * 2.0f - 1.0f,	0.01f,	// Bk
				0.69f,	0.46f * 2.0f - 1.0f,	0.42f,	// R
				-0.06f,	0.88f * 2.0f - 1.0f,	0.92f,	// Y
				-0.71f,	0.50f * 2.0f - 1.0f,	0.25f,	// G
				-0.39f,	0.55f * 2.0f - 1.0f,	-0.49f,	// C
